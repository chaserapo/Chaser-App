...
const CONTENT: Record<string, { title: string; effective: string; body: { heading?: string; text: string }[] }> = {
  ...
  terms: {
    ...
    effective: "Effective: June 2026 · Beta draft",
    body: [
      { text: "These Terms govern your use of Chaser. By creating an account or using Chaser you agree to these Terms. Chaser is operated by Midwest Ag Supplies (ABN 21 510 804 128), Morley, WA 6032, Australia. This document is provided for the Beta program only. We strongly recommend you have this document reviewed by an Australian solicitor before public release." },
      ...
      { heading: "8. Termination", text: "You may stop using Chaser and request deletion of your data at any time by contacting chaserapp@outlook.com. We may suspend or terminate an account that breaches these Terms, subject to reasonable notice unless there is an active security or legal issue." },

      { heading: "9. Governing law", text: "These Terms are governed by the laws of Western Australia, Australia. You submit to the non-exclusive jurisdiction of the courts of Western Australia and Australia." },
        ...
        {isLegal ? (
          <View style={styles.betaNotice} testID="legal-beta-notice">
            <Text style={styles.betaNoticeText}>
              Beta draft — Midwest Ag Supplies (ABN 21 510 804 128). Business details are final; we still recommend a formal review by an Australian solicitor before any public launch.
            </Text>
          </View>
        ) : null}
        <Card>
